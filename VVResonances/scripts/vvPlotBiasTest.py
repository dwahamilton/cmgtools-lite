...
parser.add_option("-o","--output",dest="output",default='biasTest',help="name of output file")
parser.add_option("-x","--minX",dest="minX",type=float,help="minimum x",default=8500)
parser.add_option("-X","--maxX",dest="maxX",type=float,help="maximum x",default=13500)
